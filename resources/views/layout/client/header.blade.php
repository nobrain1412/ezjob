            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="jp_top_header_left_wrapper">
                    <div class="jp_top_header_left_cont">
                        <p><i class="fa fa-phone"></i> &nbsp;SDT &nbsp;0343359933</p>
                        <p class=""><i class="fa fa-envelope"></i> &nbsp;Email :&nbsp;<a href="#">taquangdang4157@gmail.com</a></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm full_width">
                    <div class="gc_header_wrapper">
                        <div class="gc_logo">
                            <a href="{{route('home')}}"><img src="{{asset('images/header/logo.png')}}" alt="Logo" title="Job Pro" class="img-responsive"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 full_width">
                    <div class="header-area hidden-menu-bar stick" id="sticker">
                        ...
                        <div class="mainmenu">
                            ...
                            <ul class="float_left">
                                <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Trang chủ&nbsp;<i class="fa fa-angle-down"></i></a>
                                    <!-- mega menu start -->
                                    <ul>
                                ...
                                <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Công việc&nbsp;<i class="fa fa-angle-down"></i></a>
                                    <!-- mega menu start -->
                                    <ul>
                                ...
                                <li class="parent gc_main_navigation"><a href="#" class="gc_main_navigation">Công ty &nbsp;<i class="fa fa-angle-down"></i></a>
                                    <!-- sub menu start -->
                                    <ul>
                                ...
                                <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Bài viết&nbsp;<i class="fa fa-angle-down"></i></a>
                                    <!-- mega menu start -->
                                    <ul>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="gc_logo">
                                            <a href="index.html"><img src="{{asset('images/header/logo.png')}}" alt="Logo" title="Grace Church"></a>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
