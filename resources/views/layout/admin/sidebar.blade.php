    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                {{-- job --}}
                <a class="nav-link collapsed" href="" data-bs-toggle="collapse" data-bs-target="#collapseLayouts-job"
                    aria-expanded="false" aria-controls="collapseLayouts-job">
                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                    Job management
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapseLayouts-job" aria-labelledby="headingOne"
